...
/**
 * Provides a base class for enable node unlock forms.
 */
class UnlockForm extends ConfirmFormBase {
 ...
 */
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to unlock node %name?', ['%name' => $this->entity->label()]);
  }
  ...
  public function getConfirmText() {
    return $this->t('Unlock current page');
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, ?NodeInterface $node = NULL) {
    ...
    $form['description']['#markup'] = $this->t('You are trying to unlock page.<br />After unlocking, current page will be available to edit by others users.');
